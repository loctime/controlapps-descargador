...
"%PYTHON%" -m PyInstaller --noconfirm --clean --windowed --name "ControlApps Descargador" --collect-all yt_dlp --collect-all PySide6 --add-binary "%FFMPEG%;." --add-binary "%FFPROBE%;." run.py
